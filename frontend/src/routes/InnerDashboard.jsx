...
const InnerDashboard = () => {
  ...
  return (
    <div className="p-6 bg-white min-h-screen space-y-6 hover:shadow-lg transition duration-300 rounded-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Tenants */}
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition duration-300 transform hover:scale-[1.02] flex flex-col items-center">
          <h3 className={`${headingColor} font-bold text-lg mb-4`}>Tenants</h3>
          <div className="relative w-32 h-32 mb-4">
            <svg className="w-full h-full">
              ...
              <circle
                ...
                stroke="#ef4444"
                strokeWidth="12"
                strokeDasharray={`${(75 / 100) * 364}, 364`}
